...
public class ShoppingCartTest {
    ...
    @Test
    public void testOfRemovingFromShoppingCartShouldRemoveOneItem() throws Exception {
        // given
        shoppingCart = new ShoppingCartImpl();
        ProductItem item = new ProductItem("stapler", 1, 5.99D);
        shoppingCart.addItem(item);
    ...
    @Test
    public void testOfRemovingProductItemWithACountOfTheeShouldYieldTheCorrectTotal() throws Exception {
        // given
        shoppingCart = new ShoppingCartImpl();
        ProductItem item = new ProductItem("stapler", 3, 5.99D);
        ProductItem item2 = new ProductItem("pencils", 10, 0.49D);
    ...
    @Test
    public void testOfRemovingMultipleProductItemsWithDifferentCountsShouldYieldTheCorrectTotalAndCounts() throws Exception {
        // given
        shoppingCart = new ShoppingCartImpl();
        ProductItem item1 = new ProductItem("stapler", 3, 5.99D);
        ProductItem item2 = new ProductItem("pencils", 10, 0.49D);
    ...
    @Test
    public void testOfEmptyShoppingCartShouldContainNoItem() throws Exception {
        // given
        shoppingCart = new ShoppingCartImpl();
        ProductItem item1 = new ProductItem("stapler", 3, 5.99D);
        ProductItem item2 = new ProductItem("pencils", 10, 0.49D);
    ...
    @Test
    public void testOfEmptyMultipleProductItemsWithDifferentCountsShouldYieldTheCorrectTotalAndCounts() throws Exception {
        // given
        shoppingCart = new ShoppingCartImpl();
        ProductItem item1 = new ProductItem("stapler", 3, 5.99D);
        ProductItem item2 = new ProductItem("pencils", 10, 0.49D);
